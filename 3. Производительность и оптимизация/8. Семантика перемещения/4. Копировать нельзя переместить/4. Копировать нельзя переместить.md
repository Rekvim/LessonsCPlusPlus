...
rvalue-ссылки в С++, как и другие типы ссылок — отдельная большая тема, которая не покрывается этим курсом. В качестве дополнительного чтения можно посоветовать, например, статьи: [первую](https://habr.com/ru/articles/348198/) и [вторую](https://habr.com/ru/articles/322132/).
