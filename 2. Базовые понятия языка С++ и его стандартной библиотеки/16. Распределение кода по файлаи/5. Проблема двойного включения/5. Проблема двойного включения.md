...
Теперь понятно, что не нравится компилятору. Объявление класса `Wall` встречается несколько раз. Но убрать объявление класса в файл с реализацией нельзя. Ведь нужно знать, какие методы есть у класса, чтобы их вызывать.
